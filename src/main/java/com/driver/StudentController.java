...
public class StudentController {
    ...
    public ResponseEntity<String> addStudentTeacherPair(@RequestParam String student, @RequestParam String teacher){
        ...
        studentService.addStudentsTeachersPair(student,teacher);
    ...
    public ResponseEntity<List<String>> getStudentsByTeacherName(@PathVariable String teacher){
        List<String> students = studentService.getStudentFromTeacher(teacher); // Assign list of student by calling service layer method
    ...
    public ResponseEntity<String> deleteTeacherByName(@RequestParam String teacher){
        studentService.deleteTeacherandStudents(teacher);
